...
- [Appendix](#appendix)
    ...
    - [PlantUML Source Code](#plantuml-source-code)
...
The following figure is drawn by [PlantUML](https://plantuml.com). If you use VScode or Atom.io as markdown editor, you need a plugin `markdown-preview-enhanced`(https://shd101wyy.github.io/markdown-preview-enhanced) to view it. PlantUML source code is attached below.

![](../../img/20210600_ansible2.png)
