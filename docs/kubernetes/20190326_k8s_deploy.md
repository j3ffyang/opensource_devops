<!--
<img src=../../img/vantiq_logo2.png width=200px align="right">
<br>
<br>
-->
...
- [Install and Configure Kubernetes](#install-and-configure-kubernetes)
    ...
    - [List docker images required by Kubernetes](#list-docker-images-required-by-kubernetes)
...
- [Monitoring](#monitoring)
    ...
    - [Monitor Linux with NFS](#monitor-linux-with-nfs)
- [SSL and Certificate](#ssl-and-certificate)
    - [`cert-manager`](#cert-manager)
    - [Renew Kubernetes Certificate](#renew-kubernetes-certificate)
...
- [Misc](#misc)
    ...
    - [List all pods with `restarts`](#list-all-pods-with-restarts)
    - [List Usage by Worker-Node](#list-usage-by-worker-node)
...
- [Troubleshooting](#troubleshooting)
    ...
    - [YAML / yml format pretty print](#yaml-yml-format-pretty-print)
...
<!--
<center><img src="../../img/20190420_vantiq_k8s_openstack.png"></center>
-->
...
<img src="../../img/20190327_cp_nw_top.png">
...
#### List docker images required by Kubernetes
...
sudo kubeadm token create --print-join-command \
  kubeadm join 192.168.90.205:6443 --token yt0b52.1sioqt4m37udj55c \
  --discovery-token-ca-cert-hash \
  sha256:461b06e21243dd03d78d71213307520903e9b28981f242ddab1b0dea787e940b
```
...
Update 20210415: the chart is deprecated and moved to https://github.com/kubernetes/ingress-nginx
...
> Ref > [Prometheus SNMP-Exporter for H3C on K8S](./20201015_prom_snmp_exporter.md)

#### Monitor Windows

> Ref > https://devconnected.com/windows-server-monitoring-using-prometheus-and-wmi-exporter/

#### Monitor Linux with NFS
...
```sh
./node_exporter --collector.nfs --collector.nfsd &
```

Or

- Create a user who owns this process

> Reference > https://blog.ruanbekker.com/blog/2019/05/07/setup-prometheus-and-node-exporter-on-ubuntu-for-epic-monitoring/
...
#### YAML / yml format pretty print

Reformat yaml in pretty print format

- Backup configMap into `-o yaml`
...
```sh
kubectl -n monitoring get cm prometheus-server -o yaml \
  | sed -E 's/[[:space:]]+\\n/\\n/g' \
  | kubectl apply -f -
```
